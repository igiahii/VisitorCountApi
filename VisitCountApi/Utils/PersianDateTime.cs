...
namespace Util
{
    ...
    public class PersianDateTime
    {
        ...
        public PersianDayOfWeek DayOfWeeks
        {
            get
            {
                Enum.TryParse((((int)_dateTime.DayOfWeek + 1) % 7).ToString(), out PersianDayOfWeek day);
                return day;
            }
        }
        ...
        public static string TimeSpentComment(DateTime dateInsert)
        {
            ...
            else if (date.Hours < 1 && date.Minutes > 1)
            {
                timestr += (date.Minutes).ToString() + " دقیقه ";
                timestr += "قبل";
            }
        ...
        //public static List<ListItem> FillMonthNumber
        //{
        //    get
        //    {
        ...
        //        for (int i = 1; i <= 12; i++)
        //        {
        //            result.Add(new ListItem(i.ToString("00")));
        //        }
        ...
        //public static List<ListItem> FillDayNumber
        //{
        //    get
        //    {
        //        var result = new List<ListItem>();
